    ...
    >
        ...
        <div class="flex flex-col md:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Caknoo! 👋</p>
                <h1
                    class="
                    text-4xl
                    leading-[44px]
                ...
                <p
                    ...
                    "
                >
                I have an interest in Software Engineering, Artificial Intelligence, and Full Stack Web Developer. 
                Currently, I'm studying Backend Developer and Machine Learning
                </p>
            <button
                class="
                mt-0
                ...
                <div class="pt-4">
                    ...
                    <div class="flex items-center">
                        <a
                            ...
                            sm:mr-4
                            "
                            href="https://web.facebook.com/cakno.comel/"
                        >
                            <svg 
                            width="8"
                            height="16"
                        ...
                        <a
                            ...
                            sm:mr-4
                            "
                            href="https://twitter.com/caknoo010"
                        >
                            <svg
                            width="16"
                            height="12"
                        ...
                        <a
                            ...
                            sm:mr-4
                            "
                            href="https://www.youtube.com/channel/UCMT-QAjCLagnqGH5CwR7lVA"
                        >
                            <svg
                            width="16"
                            height="12"
                        ...
                        <a
                            ...
                            sm:mr-4
                            "
                            href="https://www.linkedin.com/in/m-naufal-badruttamam-526635217/"
                        >
                            <svg
                            width="14"
                            height="14"
